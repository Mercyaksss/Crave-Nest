...
export default function TornEdgeTop({ color = "var(--background-primary)" }) {
  return (
    <div className="torn-edge-top" aria-hidden="true">
      ...
      >
        <defs>
          <filter id="torn-paper-texture-top" x="-10%" y="-20%" width="120%" height="150%" colorInterpolationFilters="sRGB">
        ...
        {/* Flip vertically: torn (wavy) edge moves to the top, flat edge moves to the bottom */}
        <g transform="translate(0, 80) scale(1, -1)">
          <path
            fill={color}
            filter="url(#torn-paper-texture-top)"
            d="
